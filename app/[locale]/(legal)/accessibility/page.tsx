  ...
  return (
    <main className="kc-wrap" role="main" aria-labelledby="page-title">
      <section className="kc-card">
        ...
        <section className="legal__section" aria-labelledby="provider">
        ...
        <section className="legal__section" aria-labelledby="service-desc">
        ...
        <section className="legal__section" aria-labelledby="service-delivery">
        ...
        <section className="legal__section" aria-labelledby="compatibility">
        ...
        <section className="legal__section" aria-labelledby="authority">
